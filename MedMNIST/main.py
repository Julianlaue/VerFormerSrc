...
wandb.login(key='ca0ba3272b3917a522e12b7c2820696a429186f1')
wandb.init(project="PathMNIST", entity="julian-l", config={"epochs": 3, "batch_size": 128})
